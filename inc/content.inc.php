...
<div class="curr_article">
    ...
    <div>
        ...
        <?php
            ...
            <div class="maintext">
                <p><?php echo (empty($res['articles_content_ua'])) ? $res['articles_content'] . '...' : $res['articles_content_ua'] . '...'; ?></p>
            </div>
        <?php
        }
        ?>
        <div><p><?php t("Author:"); ?><a
                    href="user.php?id=<?php echo $res['articles_author'] ?>"> <?php echo $res['articles_author'] ?></a>
            </p></div>
        ...
        <div>
            ...
            if (isset($_SESSION['user'])) {
                if ($_SESSION['user'] == $res['articles_author']) { ?>
                    ...
                    <a class="bott"
                       href="articles/del.php?id=<?php echo $res['articles_id']; ?> "><?php t("Delete"); ?></a>
                    <?php
        ...
        if (!empty($resulte)) {
            ...
            foreach ($resulte as $res) {
                ...
                <div class="comment">
                    ...
                    if (isset($_SESSION['admin'])) {
                        ?>
                        <a href="comm_votes/c_dell.php?c_dell=<?php echo $res['c_id']; ?>"
                           class="bott"><?php t("Delete"); ?></a>
                    <?php
...
//Comments pager footer.
            ...
            ?>
            <div class='pager'><?php t('No commets yet.'); ?></div>
        <?php
        }
...
// Loop through each resulte.
                foreach ($art as $res) {
                    ...
                    <div class="articles">
                        ...
                        <div>
                            <p><?php t("Date of adding:"); ?> <?php echo date('F j, Y, g:i a', $res['articles_data']) ?></p>
                        </div>
