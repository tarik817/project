	...
	?>
 	...
 	<p>
			...
			<div class ="u_del">
				...
				<p class = "bott"><a href="">Delete</a></p>
			</div>
			<?php
			}
			?>
...
//Edite current user.
elseif(isset($_SESSION['admin']) && isset($_GET['ed'])){
	include_once "users/u_controler.php";
...
<?php 
	...
	<p>New password<br><input type="password" value="" name="u_pass" size="40"></p><br>
	<p>Repeat passwod<br><input type="password" value="" name="u_r_pas" size="40"></p><br>
