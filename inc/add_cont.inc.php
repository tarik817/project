...
?>
	...
	<form method ="post" action="articles/controler.php">
		...
		<p><?php t("Title"); ?><br><input type="text" name="title" size="70" value="<?php echo $res['articles_title'] ?>"></p>
		<p><?php t("Content"); ?><br><textarea name="content" cols="70" rows="10" ><?php echo $res['articles_content'] ?></textarea> </p>
